...
class AwesomeMoviePySpider(scrapy.spiders.CrawlSpider):
    name = 'awesome_movie'
    #allowed_domains = ['movie.douban.com']
    start_urls = ['https://movie.douban.com/subject/3011091/']

    rules = (Rule(LinkExtractor('https://movie.douban.com/subject/.+/?from=subject-page'),
    ...
    def parse_movie_item(self, response):
        ...
        item['score'] = response.xpath('//strong[contains(@class, "rating_num")]/text()').extract_first()
        return item
